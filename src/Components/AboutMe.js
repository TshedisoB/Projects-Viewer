          ...
          <div className="about-me-section">
            <div className="about-me-summary">
              ...
              <p>
                ...
                `Precious The Hair Stylist` establish their online presence. As
                a passionate tech enthusiast, I enjoy learning technologies that
                helps build better and scalable applications.
              </p>
              <br />
              <p>
                Since becoming a FullStack web developer at Umuzi.org, I've
                expanded my skill-set to include frontend and backend
                frameworks. In addition to keeping daily standups in check, I
                immerse myself in building responsive web and mobile
                applications.
              </p>
            </div>
